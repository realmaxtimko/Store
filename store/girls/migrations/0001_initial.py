    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('dress', 'Сукні'), ('blouse', 'Блузки'), ('skirt', 'Спідниці'), ('pants', 'Штани'), ('shorts', 'Шорти'), ('jacket', 'Куртки'), ('sweater', 'Светри'), ('shoes', 'Взуття'), ('accessories', 'Аксесуари')], max_length=20, verbose_name='Категорія')),
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='girls_clothing/', verbose_name='Зображення')),
            ],
            options={
